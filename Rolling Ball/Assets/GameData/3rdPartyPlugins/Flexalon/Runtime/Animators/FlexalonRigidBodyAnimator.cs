...
namespace Flexalon
{
    ...
    public class FlexalonRigidBodyAnimator : MonoBehaviour, TransformUpdater
    {
        ...
        {
            if (Vector2.Distance(_rectTransform.sizeDelta, size) < 0.001f)
            {
            ...
            {
                _rectTransform.sizeDelta = Vector2.Lerp(_rectTransform.sizeDelta, size, _scaleInterpolationSpeed * Time.smoothDeltaTime);
                return false;
            }
        }
