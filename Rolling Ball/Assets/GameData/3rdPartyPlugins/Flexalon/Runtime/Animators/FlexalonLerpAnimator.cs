...
namespace Flexalon
{
    ...
    public class FlexalonLerpAnimator : MonoBehaviour, TransformUpdater
    {
        ...
        public bool _animateInWorldSpace = true;
        ...
        {
            if (!_animateScale || Vector2.Distance(_rectTransform.sizeDelta, size) < 0.001f)
            {
            ...
            {
                _rectTransform.sizeDelta = Vector2.Lerp(_rectTransform.sizeDelta, size, _interpolationSpeed * Time.smoothDeltaTime);
                return false;
            }
        }
    }
