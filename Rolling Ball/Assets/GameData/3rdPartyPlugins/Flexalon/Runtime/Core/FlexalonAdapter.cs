...
namespace Flexalon
{
    ...
    internal class RectTransformAdapter : InternalAdapter
    {
        ...
        public Bounds Measure(FlexalonNode node, Vector3 size)
        {
            ...
            return new Bounds(Vector3.zero, measureSize);
        }
    ...
    internal class CanvasAdapter : InternalAdapter
    {
        ...
        public Bounds Measure(FlexalonNode node, Vector3 size)
        {
            ...
            {
                return _rectTransformAdapter.Measure(node, size);
            }
            else
            {
    ...
    internal class ImageAdapter : InternalAdapter
    {
        ...
        public Bounds Measure(FlexalonNode node, Vector3 size)
        {
            ...
            var width = _image.sprite?.rect.width ?? 0;
            var height = _image.sprite?.rect.height ?? 0;
