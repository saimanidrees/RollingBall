...
public static class YandexAppMetricaExtensionsAndroid
{
    ...
    public static AndroidJavaObject ToAndroidAdType(this YandexAppMetricaAdRevenue.AdTypeEnum self)
    {
        ...
        {
            string type = (self == YandexAppMetricaAdRevenue.AdTypeEnum.Interstitial) ? "INTERSTITIAL" : self.ToString().ToUpper();
            adType = adTypeClass.GetStatic<AndroidJavaObject>(type);
        }
